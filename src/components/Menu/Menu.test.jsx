...
describe('<Menu />', () => {
  ...
  it('should render menu mobile and button for open and close the menu', () => {
    ...
    expect(button).toHaveStyleRule('display', 'flex', { media: theme.media.IteMedium })
    expect(menuContainer).toHaveStyleRule('opacity', '0', { media: theme.media.IteMedium })
    expect(screen.getByLabelText('Open menu')).toBeInTheDocument()

    fireEvent.click(button)
    expect(menuContainer).toHaveStyleRule('opacity', '1', { media: theme.media.IteMedium })
